...
class nbrAdminSecurity{
  ...
  public function Login($user, $pass) {
    ...
    if(count($res) > 0){
      ...
      $_SESSION[$this->_getKeySession()]['name'] =      utf8_encode($res[0]->Name);
      $_SESSION[$this->_getKeySession()]['mail'] =      utf8_encode($res[0]->Mail);
      $_SESSION[$this->_getKeySession()]['developer'] = utf8_encode($res[0]->Developer);
